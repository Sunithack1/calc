//test cases written using nodeJS and Mocha assert module
...
it('correctly calculates the remainder between 10 and 3', () => {
	assert.equal(operations.remainder(10,3), 1);
});

it('indicates failure when a string is used instead of a number', () => {
	assert.equal(operations.validateNumbers('hello', 5), false);
});
